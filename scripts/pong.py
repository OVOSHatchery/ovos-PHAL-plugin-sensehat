...
def draw_ball():
    ...
    # it bounce back.
    if (ball_position[0] == 1 and y == ball_position[1]) or (
            ball_position[0] == 6 and oy == ball_position[1]):
        ball_velocity[0] = -ball_velocity[0]
        ball_velocity[1] = 0
    if ball_position[0] == 1 and y - 1 == ball_position[1] or (
            ball_position[0] == 6 and oy - 1 == ball_position[1]):
        ball_velocity[0] = -ball_velocity[0]
